      ...
      if ( !empty($_POST)) 
      {
       ...
       // validate input
        ...
        if ($valid) 
        {
               ...
               $sql = "SELECT 1 FROM TB_USUARIO WHERE login='$login' AND senha='$senha' LIMIT 1";
               
               foreach ($pdo->query($sql) as $row)
               {
                    $loggedIn = true;
                    $_SESSION['loginComum'] = $login;
                    header("Location: indexComum.php");
               }
